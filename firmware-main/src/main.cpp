...
void boot_screen() {
    ...
    tft.drawCentreString("HexPulse", tftWidth / 2, 10, 1);
    tft.setTextSize(FP);
    tft.drawCentreString(HEXPULSE_VERSION, tftWidth / 2, 25, 1);
    tft.setTextSize(FM);
    tft.drawCentreString(
        "Intelligence Platform", tftWidth / 2, tftHeight + 2, 1
...
void loop() {
    ...
    Serial.println(
        ...
        "    Version: " HEXPULSE_VERSION " | Codename: " HEXPULSE_CODENAME "\n"
        "    Website: hexmind.space\n\n"
