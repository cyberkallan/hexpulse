...
uint32_t infoCallback(cmd *c) {
    serialDevice->print("HexPulse v");
    serialDevice->println(HEXPULSE_VERSION);
    serialDevice->println("Creator: " HEXPULSE_CREATOR);
    serialDevice->println("Ecosystem: " HEXMIND_ECOSYSTEM);
...
uint32_t helpCallback(cmd *c) {
    serialDevice->print("HexPulse v");
    serialDevice->print(HEXPULSE_VERSION);
    serialDevice->print(" | " HEXMIND_ECOSYSTEM);
