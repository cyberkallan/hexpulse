...
static constexpr ColorEntry UI_COLORS[] = {
    {"Neon Cyan",      0x07FF, 0x04FF, 0x0000},  // HexPulse signature
    {"Default",       UI_COLOR_DEFAULT_PRI,       UI_COLOR_DEFAULT_SEC,       UI_COLOR_DEFAULT_BG      },
    {"Toxic Green",   0x07E0, 0x05E0, 0x0000},  // Matrix / terminal
    {"Pulse Red",     0xF800, 0xC000, 0x0000},  // Alert mode
    {"HexMind Gold",  0xFEA0, 0xDCA0, 0x0000},  // AI mode
